...
class TaskTemplateApiTests(TestCase):
    ...
    def test_template_list_includes_safe_demo_profile_required_fields(self):
        ...
        self.assertEqual(profile["target_url"], "http://echo-api:8000")
    ...
    def test_create_task_from_template(self):
        ...
        self.assertEqual(task.target_url, "http://echo-api:8000")
        self.assertEqual(task.parameters["TARGET_URL"], "http://echo-api:8000")
        self.assertEqual(task.parameters["target_url"], "http://echo-api:8000")
